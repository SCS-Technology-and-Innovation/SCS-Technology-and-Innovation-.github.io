...
function loadList(){
    ...
    quartiles = {}; // reset
    var n = maxpts; // number of regular questions
    for (var i = 1; i <= n; i++) {
...
function tern() {
    active = document.getElementById("term").options[document.getElementById("term").selectedIndex].value;
    loadList();
}
term(active);
