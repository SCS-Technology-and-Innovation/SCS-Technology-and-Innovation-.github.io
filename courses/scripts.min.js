$.each($(".component-sample"), function () {
  ...
  $(".copy-btn").on("click", function () {
    var t = $(this).parent().prev(".copy-this"),
      e = String(t[0].textContent),
  ...
  $.each($(".accordion"), function (t) {
    $(this).attr("id", "accordion_" + parseInt(t + 1));
  }),
  $.each($(".accordion > .card"), function (t, e) {
    var n = t + 1;
    $(e)
      .children(".card-header")
      .attr("id", "heading_acc_" + n),
      $(e)
        .find(".card-header > .card-title")
        .wrapInner(
          '<button  class="btn btn-link" type="button" data-toggle="collapse" aria-expanded="false"></button>'
        ),
      $(e)
...
$("div.collapse.show").prev().find("button").attr("aria-expanded", "true");
for (
  var bgImgWrapper = document.getElementsByClassName("bg-img-wrapper"),
    bgImgIndex = 0;
  bgImgIndex < bgImgWrapper.length;
  bgImgIndex++
) {
  var bgImgWrapperId = "bg-img-wrapper-" + parseInt(bgImgIndex);
  document
    .querySelectorAll(".bg-img-wrapper")
    [bgImgIndex].setAttribute("id", bgImgWrapperId);
  var bgImg = document
    .getElementById(bgImgWrapperId)
    .getElementsByTagName("img")[0].src;
  document
    .querySelectorAll(".bg-img-wrapper")
    [bgImgIndex].setAttribute("style", "background-image: url(" + bgImg + ");");
}
for (
  ...
  if (
    ...
    srTxtWrapper.appendChild(srTxt), links[linkIndex].appendChild(srTxtWrapper);
  }
}
$.each($(".list-group"), function (t) {
  $(this).attr("id", "list-tab_" + parseInt(t + 1));
}),
  $.each($(".list-group > .list-group-item"), function (t, e) {
    var n = t + 1;
    $(e).attr({
      id: "list-" + n + "-list",
      href: "#list-" + n,
  ...
  $.each($(".tab-content"), function (t) {
    $(this).attr("id", "nav-tabContent_" + parseInt(t + 1));
  }),
  $.each($(".tab-content > .tab-pane"), function (t, e) {
    var n = t + 1;
    $(e).attr({ id: "list-" + n, "aria-labelledby": "list-" + n + "-list" });
  });
